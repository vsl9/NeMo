...
if __name__ == '__main__':
    ...
    parser.add_argument('--n', type=int, help='n for n-grams', default=6)
    ...
    lmplz_tmp = 'decoders/kenlm/build/bin/lmplz --text {} --arpa {} --o {} --discount_fallback'
    command = lmplz_tmp.format(corpus_name, arpa_name, args.n)
    logging.info(command)
    os.system(command)

    tmp = 'decoders/kenlm/build/bin/build_binary trie {} {}'
